...
The "simulated_daily_rainfall.csv" in the repo is 1 year of daily observations across 60 stations (p = 60, n =365)
...
# Here you can control the size of the dataset (number of stations and number of times)
no_stations <- 60  # p
no_times <- 365    # n
...
write.csv(df, "simulated_daily_rainfall.csv")

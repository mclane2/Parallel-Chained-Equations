...
## Serial Elastic-net Chained Equations primary imputation functions ##
...
ENCE_serial <- function(df, response = "y",
                 hyp_cycles = 2,
                 max_cycles = 16,
  ...
  # Attaching the RMSE,lambda and alpha values per cycle as an attributes
